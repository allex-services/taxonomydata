...
ALLEX.execSuite.registry.registerClientSide('allex_taxonomydataservice',require('./sinkmapcreator')(ALLEX, ALLEX.execSuite.registry.getClientSide('allex_dataservice')));
...
module.exports = ['id', 'category', 'name', 'active'];
